...
export default function ModalConfiguration({
  ...
  return (
    <div className="fixed inset-0 z-30 w-full bg-black bg-opacity-20">
      <div className="w-1/3 flex flex-col justify-center h-full bg-white border-r-2 border-green-400 border-y-2 rounded-r-md bg-opacity-90 relative">
        <div
        ...
        <div className="flex flex-col justify-between h-2/3">
          <Link href={`/${id}/restaurant`}>
            <a className="w-3/4 p-2 text-white transition-all duration-300 ease-in bg-green-300 rounded-r-md hover:bg-green-400">
              Piantina
            </a>
          </Link>
          <div
            className="w-3/4 p-2 text-white transition-all duration-300 ease-in bg-green-300 rounded-r-md hover:bg-green-400"
